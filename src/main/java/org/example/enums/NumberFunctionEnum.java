...
public enum NumberFunctionEnum {
    ...
    NumberFunctionEnum(int code, String desc, String functionFormat, int argCount) {
        this.code = code;
        this.desc = desc;
    ...
    public static NumberFunctionEnum convertByCode(int code) {
        for (NumberFunctionEnum t : NumberFunctionEnum.values()) {
            if (t.getCode() == code) {
                return t;
            }
        }
